...
# Títulos y botones
titulo = tk.Label(ventana, text="Elimina el Fondo de una Imagen", font=("Arial", 18), bg="black", fg="white")
titulo.pack(pady=10)

frame_entrada = tk.Frame(ventana, bg="black", bd=2, relief="solid", highlightbackground="purple", highlightthickness=1)
frame_entrada.pack(pady=5)

btn_seleccionar = tk.Button(frame_entrada, text="Seleccionar Imagen", command=seleccionar_imagen, bg="black", fg="white")
btn_seleccionar.grid(row=0, column=0, padx=10)

frame_botones = tk.Frame(ventana, bg="black", bd=2, relief="solid", highlightbackground="purple", highlightthickness=1)
frame_botones.pack(pady=10)

btn_procesar = tk.Button(frame_botones, text="Quitar Fondo y Guardar", command=quitar_fondo_y_guardar, bg="black", fg="white")
btn_procesar.pack(pady=10)

# Labels solo para mostrar mensajes
frame_imagenes = tk.Frame(ventana, bg="black", bd=2, relief="solid", highlightbackground="purple", highlightthickness=1)
frame_imagenes.pack(pady=10)

entrada_label = tk.Label(frame_imagenes, bg="black", fg="white", width=40, height=2, text="Imagen Original")
entrada_label.grid(row=0, column=0, padx=10)

salida_label = tk.Label(frame_imagenes, bg="black", fg="white", width=40, height=2, text="Imagen sin Fondo")
salida_label.grid(row=0, column=1, padx=10)

# Label para mostrar el estado con gancho o X
estado_label = tk.Label(ventana, text="", font=("Arial", 12), bg="black", fg="white")
